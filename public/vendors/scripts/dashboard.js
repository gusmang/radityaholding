...
var options7 = {
	...
	series: [{
		name: 'In Progress',
		data: [70, 68, 57, 42, 84, 125]
	}, {
		name: 'Complete',
		data: [120, 90, 87, 80, 108, 181]
	}],
	xaxis: {
		categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
		labels: {
...
var chart7 = new ApexCharts(document.querySelector("#chart7"), options5);
chart7.render();
