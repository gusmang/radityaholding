        ...
        <div class="user-notification">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="dis-notif-button" style="display: none;">
                        <div class="btn btn-primary disabled-btn form-control" type="button">
            ...
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    <span class="user-icon">
                        <img src={{ asset("src/images/person.svg") }} alt="" style="object-fit: cover; width: 52px; height: 52px;" />
                    </span>
