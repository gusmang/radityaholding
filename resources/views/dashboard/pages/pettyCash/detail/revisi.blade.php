                ...
                <div class="card-box mb-20" style="padding: 20px 20px 30px 10px;">
                    <div class="pd-20">
                        ...
                        <div class="alert alert-danger">
                            ...
                            {{ isset($hisLast->note) ? $hisLast->note : "-" }}
                        </div>
                        <div style="clear: both;"></div>
                        <div style="width: 95%;">
                                    ...
                                    <div class="col-md-12" style="color: #444444;">
                                        <div>
                                            <input type="date" class="form-control" name="cmbTglPengajuan"
                                                id="cmbTglPengajuan" placeholder="Pilih Tanggal ..." required value="{{ date('Y-m-d') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12" style="color: #444444;">
                                        <div>
                                            <input type="text" class="form-control" name="inp_perihal" id="inp_perihal"
                                                placeholder="Input Perihal ..." required value="{{ $pettycash->perihal }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12" style="color: #444444;">
                                        <div>
                                            <input type="text" class="form-control rupiahInput" name="nominalPengajuan"
                                                id="nominalPengajuan" placeholder="Nominal Pengajuan ..." required value="{{ $pettycash->nominal_pengajuan }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12" style="padding:15px 0 15px 0; margin: 0;">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="color: #444444;">
                                        ...
                                        <textarea name="editor1" id="editor1" rows="10" cols="80">{{ $pettycash->detail }}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="width: 100%; margin-top: 30px;">
                            ...
                            <div class="row">
                                <div class="col-4" style="display: none;">
                                    <input name="hid_uuid_text" id="hid_uuid_text" type="hidden" value="{{ $pettycash->uuid }}" />
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#formAddPengadaan').on('submit', function(event) {
            ...
            const urlPengadaan = "{{ route('updatePettyCash') }}";
