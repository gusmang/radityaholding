            ...
            <div class="pd-20">
                ...
                <div style="float:left; width: 50px; height: auto;">
                    ...
                    <div style="height:130px; width: 7px; background: #EEEEEE; margin-left: 18px;">
                        <div style="width:25px; height: 25px; background: #416351; border-radius: 50%; margin-left: -8px; border: 4px solid #cfe6d9;"></div>
                    </div>
                    @endforeach
                </div>
                <div style="float:left; width: 90%;">
                    ...
                    <div class="col-md-12" style="height: 130px;">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-8" style="margin:0; padding: 0;">
                                    <h5 style="font-weight: normal; font-size: 15px; margin-top: 10px; color: #416351; font-weight: 500;">
                                        {{ $appr->title }}
                                    </h5>
                                </div>
                                <div class="col-md-4" style="margin:0; padding: 0; text-align: right;">
                                    <h5 style="font-weight: normal; font-size: 14px; margin-top: 10px; color: #555555; font-weight: normal; letter-spacing: 1px;">
                        ...
                        <div>
                            <h5 style="color: #000000; font-weight: 500; margin-top: 10px; font-size: 16px; width: 50%; letter-spacing: 1px;"><?php echo $appr->nama; ?></h5>
                        </div>
                        <div>
                            {{-- <label style="font-size: 11px; margin-top: 10px;">Catatan : </label> --}}
                            <h5 style="font-weight: normal; font-size: 14px; margin-top: 10px; color: #555555; font-weight: normal; width: 70%;  line-height: 20px;"> {{ $appr->note ? $appr->note : "-" }} </h5>
