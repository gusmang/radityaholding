...
<div class="main-container">
    ...
    @include("dashboard.pages.pettyCash.detail.sub.component.modals.modalTolak")
    @include("dashboard.pages.pettyCash.detail.sub.component.modals.modalRevisi")
...
<script type="text/javascript">
    ...
    $('#form-tolak-pengadaan-add').on('submit', function(event) {
        ...
        const urlPengadaan = "{{ route('tolakPettyCash') }}";
    ...
    $('#form-verifikasi-pettycash-rev').on('submit', function(event) {
        ...
        let urlDoc = "{{ route('revisi-pettyCash') }}";
