<div class="col-md-12 col-12 div_display_unit" id="div_tab_pembayaran" style="padding:0 0 30px 0; margin: 0; overflow: hidden;  display: none;">
    <div class="row">
        @php
        $an = 0;
        @endphp
        @foreach($pengadaan_appr as $row)
        @php
        $an++;
        @endphp
