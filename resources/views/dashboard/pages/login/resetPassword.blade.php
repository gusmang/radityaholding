...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>Reset Password - Raditya Holding</title>
...
<body class="login-page" style="background: #FFFFFF !important;">
                    ...
                    <div style="margin-top: 30px;">
                        <form method="post" id="form_lupa_password">
                            ...
                            <div class="col-md-12 mt-4" style="padding:0; margin:0;">
                                ...
                                <div>
                                    <input type="hidden" name="reset_token" id="reset_token" value="{{ isset($_GET['token']) ? $_GET['token'] : '' }}" />
                                    <input type="password" class="form-control" id="inp_kata_sandi" name="inp_kata_sandi" placeholder="Masukkan Kata Sandi" />
                                </div>
                            </div>
                            <div class="col-md-12 mt-4" style="padding:0; margin:0;">
                                <div>
                                ...
                                <div>
                                    <input type="password" class="form-control" id="inp_ulangi_kata_sandi" name="inp_ulangi_kata_sandi" placeholder="Masukkan Kata Sandi Baru" />
                                </div>
                            </div>
                            <div class="mt-4">
    ...
    <script type="text/javascript">
        ...
        document.getElementById('form_lupa_password').addEventListener('submit', function(e) {
            ...
            const urlRegist = "{{ url('reset-password'); }}";
