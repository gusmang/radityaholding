                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div>
                                    <input type="hidden" class="form-control" value="{{ $unitUsaha->id }}" name="t_index" id="t_index" placeholder="Input Index ..." required />
                                    <input type="text" class="form-control" name="unitUsaha" id="unitUsaha" value="{{ $unitUsaha->name }}" placeholder="Input Nama ..." required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mt-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="limit_petty_cash" id="limit_petty_cash" value="{{ $unitUsaha->limit_petty_cash }}" placeholder="Input Amount ..." required />
                                </div>
                            </div>

                            <div class="col-md-12 mt-4">
                                <select class="form-control" name="id_unit_bisnis" id="id_unit_bisnis" required value={{ $unitUsaha->id_unit_bisnis }}>
