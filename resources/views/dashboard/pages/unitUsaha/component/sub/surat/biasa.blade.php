<div class="div_display_unit_sub" id="table_surat_reguler">
    <table class="table stripe hover nowrap">
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <label class="switch">
                        ...
                        ?>
                            <input type="checkbox" class="switch-input" value="1" checked
                                id={{ "checked_role_pengadaan_".$an }} name={{ "checked_role_pengadaan_".$an }}>
                        <?php
                        } else {
                        ?>
                ...
                <td>
                    <select id={{ "scBiasa_role_pengadaan_".$an }} name={{ "scBiasa_role_pengadaan_".$an }}
                        class="form-control" value="{{ $row->menyetujui }}">
