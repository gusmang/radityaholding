<table class="table stripe hover nowrap div_display_unit_sub" id="table_surat_lainnya" style="display: none;">
        ...
        <tr>
            ...
            <td>
                <label class="switch">
                    ...
                    if ($row->aktif == "1") {
                    ?>
                    <input type="checkbox" class="switch-input" value="1" checked id={{ "checked_role_lainnya_".$an }}
