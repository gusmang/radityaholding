<div class="modal fade bs-example-modal-lg" id="bd-addSignature-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="required-label"> Draw Signature </label>
                                <div>
                                    <input type="hidden" name="sig_unit_usaha_edit" id="sig_unit_usaha_edit" value="{{ $unitUsaha->id }}" />
                                    <input type="hidden" class="form-control" name="sig_t_index" id="sig_t_index" placeholder="Input Index ..." required />
    ...
    <script>
        ...
        saveButton.addEventListener('click', () => {
            ...
            const urlSave = "{{ route('saveSignatureNew') }}";
