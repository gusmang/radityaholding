...
<div class="main-container">
    @include("dashboard.pages.lainnya.detail.sub.component.modals.modalVerifikasi")
    @include("dashboard.pages.lainnya.detail.sub.component.modals.modalPersetujuan")
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div style="margin-top: 120px; {{ $display_detail }}" id="div_tab_detail" class="div_display_unit">
                @include("dashboard.pages.lainnya.detail.sub.component.detail")
            </div>

            <div style="margin-top: 120px; {{ $display_pembayaran }}" id="div_tab_pembayaran" class="div_display_unit">
                @include("dashboard.pages.lainnya.detail.sub.component.history")
            </div>
