...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div style="padding:0; width: 100%; clear: both;">
                            <a href="{{ route('addPengadaanLainnya') }}" class="btn-block" type="button">
                                <?php
                                ...
                                <form method="get">
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <Button class="btn btn-primary" id="btn-submit-new" name="btn-submit-new" type="submit"
                                                value="submit">
        ...
        @include("dashboard.pages.lainnya.list.all")
