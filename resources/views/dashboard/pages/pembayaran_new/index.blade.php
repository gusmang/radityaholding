...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 mt-2">
                                            ...
                                            <select name="status_surat" id="status_surat" 
                                                placeholder="Status Surat ..." class="form-control" onchange="document.getElementById('btn-submit-new').click();">
            ...
            @include("dashboard.pages.pembayaran_new.list.progress")
            {{-- @include("dashboard.pages.pembayaran_new.list.approve")
            @include("dashboard.pages.pembayaran_new.list.pending") --}}
