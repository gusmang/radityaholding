    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                        ...
                        <div style="margin-left: 20px;">
                            <h4 class="font-20 weight-500 text-capitalize">
                                <div class="weight-600 font-24">
                                    ...
                                    <div> <small>#193245003922</small> </div>
                                </div>
                            </h4>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card-box mb-20" style="padding: 20px 20px 30px 10px;">
                            ...
                            <div style="height: 60px; display: flex; align-items: center; justify-content: flex-start; margin-top: 40px; padding:0 0 0 120px;">
                                @php $pos = 0; $inc = 1; @endphp
                                ...
                                if($pos === $pengadaan->approvedPermohonan){
                                ?>
                                <div style="width: 25%; position: relative;">
                                ...
                                else if($pos < $pengadaan->approvedPermohonan){
                                ?>
                                <div style="width: 25%; position: relative;">
                                    <div style="width: 100%; z-index: 20px; top: 20px; background: #416351; height: 4px;"></div>
                                    <div style="width: 40px; height: 40px; padding: 7px; border-radius: 50%; background: #416351; position: absolute; z-index: 50; top: -20px;">
                            ...
                            <div class="col-md-12 col-12 d-flex" style="padding: 20px 0 0 80px;">
                                ...
                                <div style="width: 25%; text-align: {{ strlen($rows->role) > 5 ? "left" : "left" }}; background: #FFFFFF;">
                                    <h5 style="font-size: 16px; font-weight: 500; width: 150px; "> {{ $rows->role }} </h5>
            ...
            <div style="margin-top: 120px; {{ $display_detail }}" id="div_tab_detail" class="div_display_unit">
                @include("dashboard.pages.pembayaran.detail.sub.component.detail")
            </div>

            <div style="margin-top: 120px; {{ $display_pengadaan }}" id="div_tab_pengadaan" class="div_display_unit">
                @include("dashboard.pages.pembayaran.detail.sub.component.informasi")
            ...
            <div style="margin-top: 120px; {{ $display_pembayaran }}" id="div_tab_pembayaran" class="div_display_unit">
                @include("dashboard.pages.pembayaran.detail.sub.component.history")
