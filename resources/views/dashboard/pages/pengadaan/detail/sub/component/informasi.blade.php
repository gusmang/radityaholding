        ...
        <div class="card-box mb-20" style="padding: 20px 20px 30px 10px;">
            <div class="pd-20">
                ...
                <div style="width: 100%; mt-4">
                    ...
                    if(count($setuju) == 0){
                    ?>
                    <div class="div-current mt-2 d-flex align-items-center justify-content-center" style="padding: 20px;">
                        <div style="width:5%">
                            <div style="width:20px; height: 20px; border-radius: 50%; border:1px solid #FF6600; text-align: center;">
                                <span style="color: #FF6600;"> ! </span>
                            </div>
                        </div>
                        <div style="width:95%;">
                            <h5 style="font-size: 16px; font-weight: 500;"> Surat keterangan belum dibuat. Surat keterangan akan dibuat sekretariat setelah berkas sudah diverifikasi dan disetujui. </h5>
                        </div>
                    </div>
                    <?php
                    }
