<div id="div-lap-pengadaan" class="div_display_unit">
        ...
        <table class="table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="<?php echo route('createZipPengadaan',['index' => $row->id]); ?>" target="_blank">
