<div id="div-lap-pettycash" style="display: none;" class="div_display_unit">
        ...
        <table class="table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="<?php echo route('createZipPettycash',['index' => $row->id]); ?>" target="_blank">
